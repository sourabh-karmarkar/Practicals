...
"""
	...
	A) If the value entered by the user is not floating point then the program may crash. 
	   To handle this we will have to check whether the value entered by the user is a floating point or not. We 		   will have to handle the error when the input is being converted to float. If it is float then proceed else 		   give an appropriate message.
"""
