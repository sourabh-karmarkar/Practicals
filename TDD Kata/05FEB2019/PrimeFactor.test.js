...
describe('Prime Factor Calculation Test Cases', () => {
    ...
    test('Input : 5436880 ---> Output : 2,2,2,2,5,67961', () => {
        expect(primeFactorObj.primeFactorFunction(5436880)).toEqual([2,2,2,2,5,67961])
    });
});