let primeFactorObj = require('./PrimeFactor')
...
describe('Prime Factor Test Cases', () => {
    ...
    test('Input : 432432 ---> Output : 2,2,2,2,3,3,3,7,11,13', () => {
        expect(primeFactorObj.primeFactorFunction(432432)).toEqual([2,2,2,2,3,3,3,7,11,13])
    });
});